...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "single_extruder_multi_material", "ace_head_capacity", "ace_head_unit", "manual_filament_change", "machine_start_gcode", "machine_end_gcode", "before_layer_change_gcode", "printing_by_object_gcode", "layer_change_gcode", "time_lapse_gcode", "change_filament_gcode", "change_extrusion_role_gcode",
