...
public:
        ...
        , m_selectedIndex(selectedIndex)
    {
        ...
        // scrolling, and a U1 lists four toolheads plus every ACE slot, which is well past
        // the fixed height this was written for. Matches the row layout used in
        // render()/hitTestRow - symmetric g_firstRowY padding top and bottom - and keeps
        // the old fixed height for an empty list. Capped as a sanity bound.
