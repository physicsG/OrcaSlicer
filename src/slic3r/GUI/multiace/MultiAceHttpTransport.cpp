...
HttpRestTransport::HttpRestTransport(HttpTransportConfig config) : m_config(std::move(config))
{
...
TransportResponse HttpRestTransport::get(const std::string& path)
{
    return perform_request(false, path, {});
}

TransportResponse HttpRestTransport::post(const std::string& path, const std::string& body)
{
    return perform_request(true, path, body);
}

TransportResponse HttpRestTransport::perform_request(bool post_request, const std::string& path, const std::string& body)
{
...
std::string HttpRestTransport::build_url(const std::string& path) const
{
    if (path.empty())
